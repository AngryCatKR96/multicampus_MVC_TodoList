...
<section style="padding: 15px">
    ...
    <br>
    <div>
        <input class="form-check-input" type="checkbox" name="types" value="t" ${SearshDTO.checkType("t")?"checked":""}>
        <label class="form-check-label" >
            제목
        </label>
        <input class="form-check-input" type="checkbox" name="types" value="w" ${SearshDTO.checkType("w")?"checked":""}>
        <label class="form-check-label" >
            작성자
        </label>
    </div>
    ...
    <div class="form-floating mb-3">
        <input type="text" class="form-control" id="floatingInput" placeholder="검색내용" name="searchContent">
