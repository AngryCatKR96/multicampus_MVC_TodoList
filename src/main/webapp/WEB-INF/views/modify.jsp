    ...
    <div class="card">
        <form action="/modify" method="post">
            ...
            <div class="input-group mb-3">
                ...
                <input type="date" class="form-control" value="${dto.dueDate}" name="dueDate" >
            </div>
            <div class="input-group mb-3">
            ...
            <div class="form-check">
                <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault" name="finished" <c:if test="${dto.finished eq '1'}">checked</c:if>>
            ...
            <button type="button" style="float: right; margin: 5px"  class="btn btn-secondary"  onclick="location.href='/list'">List</button>
